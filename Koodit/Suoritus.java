...
public class Suoritus {
	...
	public Suoritus(int id, float kh, String t, int tm, float th, float ktv, float al, String tt){
		this.id = id;
	...
	public Suoritus(float kh, String t, int tm, float th, float ktv, float al, String tt){
		kaytetytTarvikkeet = new Tarvikeluettelo();
		this.kokonaisHinta = kh;
		type = t;
		tuntimaara = tm;
	...
	public HashMap getTarvikkeet(){
		System.out.println(kaytetytTarvikkeet.getTarvikkeet());
